...
# funct STYLE FONT
change_polybar 'adaptive-fynx' 'Iosevka Nerd Font:size=10;3' && "$polybar_path"/launch.sh

# funct STYLE FONT BORDER BORDER-RADIUS ICON (Change colors in funct)
change_rofi 'adaptive-fynx' 'Iosevka 10' '0px' '0px' 'Papirus-Apps'

# funct STYLE (network manager applet)
change_nm 'adaptive-fynx'
...
change_appearance 'Adapta-Nokto' 'Luv-Folders-Dark' 'Vimix' 'Noto Sans 10'

# funct THEME LAYOUT FONT SIZE (Change margin in funct)
obconfig 'Adapta-Nokto' 'LIMC' 'SauceCodePro Nerd Font Mono' '10' 'menu-icons.xml' && openbox --reconfigure
